import $ from "jquery";
import capture from "./StudentFormCapture.html";
export class StudentListView {
  ...
  generateStudentHtml(student) {
    ...
    <td>
      <form>
      <input type="text" id="0" class="markInput"  value='${marks[0]}'/>
      <input type="text" id="1" class="markInput"  value='${marks[1]}'/>
      <input type="text" id="2" class="markInput"  value='${marks[2]}'/>
      <input type="text"  id="3"class="markInput"  value='${marks[3]}'/>
      <input type="text"  id="4" class="markInput"  value='${marks[4]}'/>
      <input type="text"  id="5" class="markInput"  value='${marks[5]}'/>
      <input type="text"  id="6" class="markInput" value='${marks[6]}'/>
      <input type="text"  id="7" class="markInput" value='${marks[7]}'/>
      <input type="text"  id="8" class="markInput"  value='${marks[8]}'/>
      <input type="text"  id="9" class="markInput"  value='${marks[9]}'/>
      </form>
    </td>
